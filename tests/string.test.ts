...
it("will Truncates string if it's longer than the given maximum string length. The last characters of the truncated string are replaced with the omission string which defaults to", () => {
  expect(
    truncate(
      "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia modi blanditiis odio eius! Dolor, iusto quod atque quibusdam sequi fugit excepturi debitis quidem ut adipisci doloremque! In, perferendis facere porro.",
      10,
    ),
  ).toBe("Lorem ipsu...");
});
