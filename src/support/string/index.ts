...
export default str;
export { after, before, between, camel, capitalize, headline, kebab, limit, lowerCaseFirst, mask, pad, random, slug, snake, SPECIAL_CHARTERS, SPECIAL_CHARTERS_REGEX, squish, studly, swap, title, trim, upperCaseFirst, uuid, wordCount };
